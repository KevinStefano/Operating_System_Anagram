...
ld86 -o ls -d ls.o lib_asm.o libFileIO.o libFolderIO.o libMatematika.o 
./loadFile ls

bcc -ansi -c -o mkdir.o mkdir.c
ld86 -o mkdir -d mkdir.o lib_asm.o libFileIO.o libFolderIO.o libMatematika.o 
./loadFile mkdir


bcc -ansi -c -o rm.o rm.c
ld86 -o rm -d rm.o lib_asm.o libFileIO.o libFolderIO.o libMatematika.o 
./loadFile rm


bcc -ansi -c -o cat.o cat.c
ld86 -o cat -d cat.o lib_asm.o libFileIO.o libFolderIO.o libMatematika.o 
./loadFile cat
